...
export const cartReducer = (state = initialState, { type, payload, quantity }) => {
    ...
    switch (type) {
        ...
        case ActionTypes.LOADING_SUCCESS_CART:
            ...
            console.log(sumQuantity(payload))
               

            // return {
            //     ...state,
            //     // products: payload,
            //     // quantity: sumQuantity(payload),
            //     isLoading: false
            // };
        ...
        case ActionTypes.ADD_ONE_TO_CART:
            ...
            if (state.products) {
                state.products.map((item) => {
                    if (item.selectedProduct._id === payload.selectedProduct.selectedProduct._id) {
                ...
                products: state.products ?
                    ...
                    itemFoundAddOne ?
                        ...
                        state.products.map((item, i) =>
                            ...
                            item.selectedProduct._id === payload.selectedProduct.selectedProduct._id
        ...
        case ActionTypes.REMOVE_FROM_CART:
            ...
            console.log(state.products)
            console.log(state.products.filter(item => item.selectedProduct._id !== payload.selectedProduct.selectedProduct._id))
            return {
                ...state,
                ...
                products: state.products ?
                    ...
                    itemFoundRemove ?
                        ...
                        state.products.filter(item => item.selectedProduct._id !== payload.selectedProduct.selectedProduct._id)
                ...
                total: state.total - payload.selectedProduct.selectedProduct.price * payload.selectedProduct.quantity,
                isLoading: false
            };
