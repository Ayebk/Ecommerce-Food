            ...
            <div className="userContainer">
                <div className="userShow">
                    <div className="userShowTop">
                        <img src={ user?.img ? user?.img : "https://res.cloudinary.com/dzy0uevma/image/upload/v1645617415/e-commerce/lq5l1h0gr4vnbid8nc7a.webp"} alt="" className="userShowImg" />
                    ...
                    <form className="userUpdateForm" onSubmit={handleUpdate}>
                        ...
                        <div className="userUpdateRight">
                            <div className="userUpdateUpload">
                                <img  src={img ? URL.createObjectURL(img) : null} width="90%" height="auto" alt="" className="userUpdateImg" />
                                <div className="userInputFileIcon">


                                </div>
                                <div className="userInputFileIcon">
                                    <label style={{ cursor: "pointer" }} htmlFor="file" ><Publish /></label>
