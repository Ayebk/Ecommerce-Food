    ...
    useEffect(() => {
     const getIncome = async()=>{
         try{
            ...
            setPerc((res.data.find((p) => p._id == "2").total *100) / res.data.find((p) => p._id == "1").total   )
         }catch(err){
             console.log(err)
         }
     }
    ...
    useEffect(() => {
     const getIncome = async()=>{
         try{
            ...
            setPercSales((res.data.find((p) => p._id == "2").total *100) / res.data.find((p) => p._id == "1").total   )
         }catch(err){
             console.log(err)
         }
     }
        ...
        <div className="featured">
            ...
            <div className="featuredItem">
                ...
                <span className="featuredMoneyBlur">₪xxxx</span>
                     ...
                     %{Math.floor(percSales)} <ArrowDownward className="featuredIcon negative"/>
                     </span>
                :
                <span className="featuredMoneyRateBlur">
